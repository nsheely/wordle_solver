//! Wordle word representation with optimized letter position tracking
//!
//! A Word stores a 5-letter word along with precomputed letter position indices
//! for fast pattern calculation.

use rustc_hash::FxHashMap;
use std::fmt;

/// A 5-letter Wordle word with precomputed letter positions
///
/// Stores the word as bytes for efficient pattern calculation and maintains
/// a map of letter positions for quick lookup during duplicate handling.
